...
puts thirds_product([1, 2, 3]) == 3
puts thirds_product([0, 1, 2, 3, 4, 5]) == 10
puts thirds_product([1, 2, 5, 3, 4, 0, 6, 4, 2]) == 0
...
# Your method should count the number of times the sentence uses the word "like".
...
puts pair_product?([2, 2, 6, 8], 4) == true
